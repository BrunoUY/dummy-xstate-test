...
function sendTo$1(actor, event, options) {
  return send$1(event, __assign(__assign({}, options), {
    to: actor
  }));
}
...
function escalate(errorData, options) {
  return sendParent$1(function (context, event, meta) {
    return {
      type: error$1,
...
function fromPromise(promiseFn) {
  ...
  return {
    transition: function (state, event, _a) {
      ...
      switch (event.type) {
        case 'fulfill':
          parent === null || parent === void 0 ? void 0 : parent.send(doneInvoke$1(id, event.data));
          return {
            error: undefined,
            data: event.data,
            status: 'fulfilled'
...
function () {
  ...
  StateNode.prototype.resolveTransition = function (stateTransition, currentState, context, predictableExec, _event) {
    ...
    var _f = __read(partition(resolvedActions, function (action) {
      return action.type === raise$2 || action.type === send$2 && action.to === SpecialTargets.Internal;
    }), 2),
        raisedEvents = _f[0],
...
/** @xstate-layout -CKjSjUWgAvJrQrKPRaMwQqEqGGQ+GIvR6bYGLRqKpwkw6eoufGEkZRGJxfBQclA9agIo6Nz3a7wkxPPTXSys1zuXyVeG1WpaXgqfVCoZEqKTaYQKX5GUKRAGeEkPQqaqWSx1cweQ6sx3Oyz+erXfzPSyvQJAA */
createMachine({
  ...
  on: {
    ...
    LIKE: {
    // addn an action to like the song
    },
    DISLIKE: {
