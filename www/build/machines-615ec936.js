...
createMachine({
  ...
  actions: {
    setSongData: () => { console.log('action: setSongData'); },
    ...
    likeSong: () => { console.log('action: likeSong'); },
    dislikeSong: () => { console.log('action: dislikeSong'); },
    unlikeSong: () => { console.log('acion: unlikeSong'); },
    changeVolume: () => { console.log('action: changeVolume'); },
  },
});
